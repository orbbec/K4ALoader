...
namespace k4a
{
	...
	public:
		 ...
		 */
		image(image&& other) noexcept : m_handle(other.m_handle), kl_handle(other.kl_handle)
		{
			other.m_handle = nullptr;
			other.kl_handle = nullptr;
		}
		...
		void reset() noexcept
		{
			if (m_handle != nullptr)
			{
				kl_handle->k4a_image_release(m_handle);
				m_handle = nullptr;
			}
		...
		{
			return kl_handle->k4a_image_get_buffer(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_size(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_format(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_width_pixels(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_height_pixels(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_stride_bytes(m_handle);
		}
		...
		{
			return std::chrono::microseconds(kl_handle->k4a_image_get_device_timestamp_usec(m_handle));
		}
		...
		{
			return std::chrono::nanoseconds(kl_handle->k4a_image_get_system_timestamp_nsec(m_handle));
		}
		...
		{
			return std::chrono::microseconds(kl_handle->k4a_image_get_exposure_usec(m_handle));
		}
		...
		{
			return kl_handle->k4a_image_get_white_balance(m_handle);
		}
		...
		{
			return kl_handle->k4a_image_get_iso_speed(m_handle);
		}
		...
		{
			kl_handle->k4a_image_set_device_timestamp_usec(m_handle, internal::clamp_cast<uint64_t>(timestamp.count()));
		}
		...
		{
			kl_handle->k4a_image_set_exposure_usec(m_handle, internal::clamp_cast<uint64_t>(exposure.count()));
		}
		...
		{
			kl_handle->k4a_image_set_white_balance(m_handle, white_balance);
		}
		...
		{
			kl_handle->k4a_image_set_iso_speed(m_handle, iso_speed);
		}
	...
	public:
		 ...
		 */
		capture(capture&& other) noexcept : m_handle(other.m_handle), kl_handle(other.kl_handle)
		{
			other.m_handle = nullptr;
			other.kl_handle = nullptr;
		}
		...
		void reset() noexcept
		{
			if (m_handle != nullptr)
			{
				kl_handle->k4a_capture_release(m_handle);
				m_handle = nullptr;
			}
			if (kl_handle != nullptr)
			{
		...
		{
			kl_handle->k4a_capture_set_color_image(m_handle, color_image.handle());
		}
		...
		{
			kl_handle->k4a_capture_set_depth_image(m_handle, depth_image.handle());
		}
		...
		{
			kl_handle->k4a_capture_set_ir_image(m_handle, ir_image.handle());
		}
		...
		{
			kl_handle->k4a_capture_set_temperature_c(m_handle, temperature_c);
		}
		...
		{
			return kl_handle->k4a_capture_get_temperature_c(m_handle);
		}
	...
	public:
		...
		void destroy() noexcept
		{
			if (m_handle != nullptr)
			{
				kl_handle->k4a_transformation_destroy(m_handle);
				m_handle = nullptr;
			}
			if (kl_handle != nullptr)
			{
		...
		{
			k4a_result_t result = kl_handle->k4a_transformation_depth_image_to_color_camera(m_handle,
				depth_image.handle(),
		...
		{
			k4a_result_t result = kl_handle->k4a_transformation_depth_image_to_color_camera_custom(m_handle,
				depth_image.handle(),
				custom_image.handle(),
				transformed_depth_image->handle(),
		...
		{
			k4a_result_t result = kl_handle->k4a_transformation_color_image_to_depth_camera(m_handle,
				depth_image.handle(),
				color_image.handle(),
		...
		{
			k4a_result_t result =
				kl_handle->k4a_transformation_depth_image_to_point_cloud(m_handle, depth_image.handle(), camera, xyz_image->handle());
			if (K4A_RESULT_SUCCEEDED != result)
			{
	...
	public:
		 ...
		 */
		device(device&& dev) noexcept : m_handle(dev.m_handle), kl_handle(dev.kl_handle)
		{
			dev.m_handle = nullptr;
			dev.kl_handle = nullptr;
		}
		...
		void close() noexcept
		{
			if (m_handle != nullptr)
			{
				kl_handle->k4a_device_close(m_handle);
				m_handle = nullptr;
			}
			if (kl_handle != nullptr)
			{
		...
		bool get_capture(capture* cap, std::chrono::milliseconds timeout)
		{
			...
			k4a_wait_result_t result = kl_handle->k4a_device_get_capture(m_handle, &capture_handle, timeout_ms);
		...
		{
			int32_t timeout_ms = internal::clamp_cast<int32_t>(timeout.count());
			k4a_wait_result_t result = kl_handle->k4a_device_get_imu_sample(m_handle, imu_sample, timeout_ms);
			if (result == K4A_WAIT_RESULT_FAILED)
			{
		...
		{
			k4a_result_t result = kl_handle->k4a_device_start_cameras(m_handle, configuration);
			if (K4A_RESULT_SUCCEEDED != result)
			{
		...
		{
			kl_handle->k4a_device_stop_cameras(m_handle);
		}
		...
		void start_imu()
		{
			k4a_result_t result = kl_handle->k4a_device_start_imu(m_handle);
			if (K4A_RESULT_SUCCEEDED != result)
			{
		...
		{
			kl_handle->k4a_device_stop_imu(m_handle);
		}
		...
		std::string get_serialnum() const
		{
			...
			size_t buffer = 0;
			k4a_buffer_result_t result = kl_handle->k4a_device_get_serialnum(m_handle, &serialnum[0], &buffer);

			if (result == K4A_BUFFER_RESULT_TOO_SMALL && buffer > 1)
			{
				serialnum.resize(buffer);
				result = kl_handle->k4a_device_get_serialnum(m_handle, &serialnum[0], &buffer);
		...
		{
			k4a_result_t result = kl_handle->k4a_device_get_color_control(m_handle, command, mode, value);
			if (K4A_RESULT_SUCCEEDED != result)
			{
		...
		{
			k4a_result_t result = kl_handle->k4a_device_set_color_control(m_handle, command, mode, value);
			if (K4A_RESULT_SUCCEEDED != result)
			{
		...
		std::vector<uint8_t> get_raw_calibration() const
		{
			...
			size_t buffer = 0;
			k4a_buffer_result_t result = kl_handle->k4a_device_get_raw_calibration(m_handle, nullptr, &buffer);

			if (result == K4A_BUFFER_RESULT_TOO_SMALL && buffer > 1)
			{
				calibration.resize(buffer);
				result = kl_handle->k4a_device_get_raw_calibration(m_handle, &calibration[0], &buffer);
		...
		bool is_sync_in_connected() const
		{
			...
			k4a_result_t result = kl_handle->k4a_device_get_sync_jack(m_handle, &sync_in_jack_connected, &sync_out_jack_connected);
		...
		k4a_hardware_version_t get_version() const
		{
			...
			k4a_result_t result = kl_handle->k4a_device_get_version(m_handle, &version);
